...
class SalesforceClient(
    ...
    val sfPathSObject = lazy { "/services/data/$SALESFORCE_VERSION/composite/sobjects" }
    ...
    fun enablesObjectPost(doSomething: ((String) -> Response) -> Unit): Boolean {
        val doPostRequest: (String, SFAccessToken.Exists) -> Response = { b, at ->
            httpClient.value
                .measure(at.getPostRequest(sfPathSObject.value).body(b), metrics.responseLatency)
